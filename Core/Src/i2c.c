...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(ACC_GYRO_IMU_I2C1_SCL_GPIO_Port, ACC_GYRO_IMU_I2C1_SCL_Pin);

    HAL_GPIO_DeInit(ACC_GYTO_IMU_I2C1_SDA_GPIO_Port, ACC_GYTO_IMU_I2C1_SDA_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(MAG_IMU_I2C3_SDA_GPIO_Port, MAG_IMU_I2C3_SDA_Pin);

    HAL_GPIO_DeInit(MAG_IMU_I2C3_SCL_GPIO_Port, MAG_IMU_I2C3_SCL_Pin);
