...
TrajectoryBuffer trajectory_buffer;
...
uint8_t GUI_onoff;
uint8_t GUI_command;
uint8_t sync_mode_onoff;

cvector_vector_type(MsgDataObjectHeader) pdo_send_list;

cvector_vector_type(MsgDataObjectHeader) sdo_req_list;
cvector_vector_type(MsgDataObjectHeader) sdo_res_list;
...
float msg_time_elapsed;

uint8_t test_cmd;
uint8_t test_cmd_1;
uint32_t msg_hdlr_loop_cnt;

//uint32_t msg_hdlr_loop_time_cnt_1;
//uint32_t msg_hdlr_loop_time_cnt_2;
//uint32_t msg_hdlr_loop_time_us;
