...
#ifndef FRAMEWORK_APPS_FDCAN_MSG_HDLR_FDCAN_COMMON_H_
#define FRAMEWORK_APPS_FDCAN_MSG_HDLR_FDCAN_COMMON_H_
...
#endif /* FRAMEWORK_APPS_FDCAN_MSG_HDLR_FDCAN_COMMON_H_ */
