...
ICMObject icm20608g_obj;
BMObject bm1422agmv_obj;
...
uint32_t imu_us=0;
uint8_t err_chk_icm = 321;
uint8_t err_chk_bm = 123;

uint8_t i2c_6axis_res = 111;
uint8_t i2c_3axis_res = 222;
...
//	err_chk_6axis = Init_6Axis_IMU(&icm20608g_obj);
...
//	Calculate_Initial_Thigh_Angle(&thigh_angle_params, &norm_params, &acc_gyro_data, &sensor_params, attach_plane);
