/*
 * bsp_bm1422agmv_regmap.h
 *
 *  Created on: Aug 7, 2023
 *      Author: Seung-WonYun
 */

#ifndef DRIVERS_BSP_BM1422AGMV_INC_BSP_BM1422AGMV_REGMAP_H_
#define DRIVERS_BSP_BM1422AGMV_INC_BSP_BM1422AGMV_REGMAP_H_

/* Device Specification */
#define BM1422AGMV_SENSITIVITY_14BIT                24
#define BM1422AGMV_SENSITIVITY_12BIT                6

/* Device Address */
#define BM1422AGMV_DEV_ADDR_L                       0b0001110
#define BM1422AGMV_DEV_ADDR_H                       0b0001111
#define BM1422AGMV_DEV_MAX_HW_ID                    0b0001

#define BM1422AGMV_DEV_ADDR 						0x1C
#define BM1422AGMV_CONTROL_SIZE                    	1U
#define BM1422AGMV_CNTL4_REG_L                      0x5CU
#define BM1422AGMV_CNTL4_REG_H                      0x5DU
#define BM1422AGMV_CONTROL_SIZE						1U
...
// USED CNTL Register //
#define BM1422AGMV_CNTL1_VALUE 						0b11011000U;			// 0xC0 : 14Bit(8192),10Hz,Continuous // 0x80 : 12Bit(2048),10Hz,Continuous // 0xD8 : 14Bit,1KHz,Continuous // 0xDA : 14Bit,1KHz,Single mode
//#define BM1422AGMV_CNTL2_VALUE 						0x0CU;
#define BM1422AGMV_CNTL2_VALUE 						0b00000000U;			// 0x00 : DRDY is not used // 0x08 : DRDY is used when the output is HIGH // 0x0C : DRDY is used when the output is LOW
#define BM1422AGMV_CNTL3_VALUE 						0b01000000U;			// Write "FORCE" = 1 for  measurement
#define BM1422AGMV_CNTL4_H_VALUE 					0b00000000U;
#define BM1422AGMV_CNTL4_L_VALUE 					0b00000000U;
///////////////////////////////////////////////////////////
...
#endif /* DRIVERS_BSP_BM1422AGMV_INC_BSP_BM1422AGMV_REGMAP_H_ */
