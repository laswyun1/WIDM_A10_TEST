...
TimCallback ioif_tim1_callback_ptr = NULL;
TimCallback ioif_tim2_callback_ptr = NULL;
TimCallback ioif_tim3_callback_ptr = NULL;
TimCallback ioif_tim4_callback_ptr = NULL;
TimCallback ioif_tim5_callback_ptr = NULL;
TimCallback ioif_tim6_callback_ptr = NULL;
TimCallback ioif_tim7_callback_ptr = NULL;
TimCallback ioif_tim8_callback_ptr = NULL;
TimCallback ioif_tim9_callback_ptr = NULL;
TimCallback ioif_tim10_callback_ptr = NULL;
TimCallback ioif_tim11_callback_ptr = NULL;
TimCallback ioif_tim12_callback_ptr = NULL;
TimCallback ioif_tim13_callback_ptr = NULL;
TimCallback ioif_tim14_callback_ptr = NULL;
TimCallback ioif_tim15_callback_ptr = NULL;
